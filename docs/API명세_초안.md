...
> **작성일** 2026.07.30 · **현행성 점검** 2026.08.01 · 설계 근거는
...
>
> 실행 중인 앱의 OpenAPI 스펙과 이 문서를 전수 대조했습니다. **외부 30개 전부
> 구현됐고, 경로·메서드가 하나도 어긋나지 않습니다.** 내부 1개는 `ai/server` 에
> 있습니다. 빠진 3개는 아래 「전체 목록」의 철회 사유를 보세요.
