...
**시안은 HWP(01·02·04·05)와 `db/schema.sql` 기준으로 맞췄습니다.** 그 과정에서 화면설계서
PPTX 와 HWP 가 어긋나는 곳이 나왔습니다.

| 항목 | 화면설계서 PPTX | 01·02·04·05 · `schema.sql` | 시안 처리 |
|---|---|---|---|
| `USERS.phone` | 「**비상** 연락처」 | 「연락처」 (04 2절, 05 컬럼 정의) | **연락처**로 표기 |
...
- **「비상 연락처」는 의미가 다릅니다.** 비상연락처는 보호자 등 제3자 번호이고
  ...
  본인 연락처로 두려면 화면설계서 문구를, 보호자 연락처로 두려면 04·05 에 컬럼을 고쳐야 합니다.
