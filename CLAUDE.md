...
>
> **평가셋 사람 검수가 끝났습니다** — `source` 200/200 `team`. 재채점 결과
> **재현율 0.835 · F1 0.887** 입니다.
> ⚠ **`0.919` 를 쓰지 마세요** — AI 초안으로 잰 값이라 「사람이 작성」
> 요건을 못 채웁니다. 드러나면 방어할 수 없습니다.
>
> **지금 가장 급한 것 둘** — ① 평가셋 **교차 라벨링(κ)** 진행 중. 끝나야
> `NFR-AI-001` 이 닫힙니다 ② 기획서 개정 잔여 18건 — **요구사항정의서에
> 11건이 몰려 있습니다.** 그 밖에 Health Connect 실기기 검증과 FCM 발송
