...
> **현행성 점검** 2026.08.02 · 화면설계서 21장 개정이 끝났고, 그 문서를 기준으로
> 앱을 대조해 어긋난 6건을 맞췄습니다. 위기 판정 평가셋 200건을 채웠지만
> **180건이 AI 초안이라 사람 검수가 필요**하고, LLM 채점은 무료 한도 때문에
> **10일이 걸립니다** — 지금 가장 급한 것이 이 둘입니다. 그 밖에 Health Connect
> 실기기 검증과 콘텐츠·QA·`LLM_PROVIDER` 전환이 남았습니다.
...
- **화면설계서가 정본입니다.** 앱이 문서와 어긋난 6건을 2026.08.02 에 맞췄습니다
  → [`docs/검증/문서-구현_대조_20260802.md`](docs/검증/문서-구현_대조_20260802.md)
