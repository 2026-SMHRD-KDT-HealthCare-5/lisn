...
규칙 — 화면 위에 얹는 자막(앱 컷·관제 컷)은 전부 아래를 지킵니다.
  번호  fontsize 30 · INDIGO · x=170
  제목  fontsize 76 · NAVY   · x=170
  설명  fontsize 30 · MUTED  · x=170
...
COLORSLOT = {"@I@": "INDIGO", "@N@": "NAVY", "@M@": "MUTED"}
...
def main():
    ...
    if bad:
        ...
        return 1
    print(f"✓ 자막 {seen}곳이 모두 같은 규칙을 씁니다 (번호 인디고30 · 제목 남색76 · 설명 회색30 · x=170)")
    return 0
