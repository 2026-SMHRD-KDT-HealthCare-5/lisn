...
async function main() {
  ...
  // ============================================================
  {
    ...
    const steps = [
      // 2026.08.25 — 아래 두 항목은 PowerPoint 로 직접 다듬은 문구입니다
      // (문장 둘을 하나로 합치고 · "그 사람"을 "사용자"로 통일).
      ['01', '자동 수집', 'Health Connect·화면 사용 시간을 앱이 사용자가 입력할 필요 없이 자동으로 읽어 보냅니다.'],
      ['02', '평소와 얼마나 다른가', '사용자 본인의 평소(14일)와 비교해 징후를 봅니다. 감정을 분류하지 않습니다.'],
