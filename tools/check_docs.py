...
#                      문서에서 지운 이유의 출처입니다.
#   발표자료           **2026.08.04 에 개정 범위에서 빠졌습니다**(PM 결정).
#                      기획서 발표는 끝났고 PL-20~PL-24 는 8/28 최종 발표
#                      준비 시점으로 이월됐습니다. 범위 밖인 것을 계속
#                      실패로 띄우면 **검사기가 0 이 될 수 없어** 완료 판정
#                      기준으로 못 씁니다.
#
# ⚠ 8/28 준비를 시작하면 발표자료를 다시 넣으세요.
#
