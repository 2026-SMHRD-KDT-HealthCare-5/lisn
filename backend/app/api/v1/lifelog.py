...
async def push_lifelog(body: LifelogBatch, user: CurrentUser, db: DbSession):
    ...
    # TODO(분석): MLCM_210 — 적재 완료 후 AI 추론 서버로 분석을 트리거해야 한다.
    #   POST {AI_SERVER_URL}/internal/analyze/lifelog
    #   챗봇 라우터와 함께 붙인다.
